...
import { apiFilterClosedCalls } from "@/app/api/Convocatorias/filterClosedCalls";

function ConvocatoriasCerradasAdminPage() {
...
export default ConvocatoriasCerradasAdminPage;

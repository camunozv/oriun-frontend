        ...
        <div className="relative mt-4 mx-auto overflow-hidden max-w-[1580px] gap-3 flex flex-col justify-center items-center w-full rounded-lg shadow-lg p-6">
            <div className="w-full flex flex-col items-start justify-start gap-3">
              ...
              >
                ...
                con el siguiente menu podra filtrar las postulaciones por el parametro que se necesite para seleccionar los ganadores.
            ...
            <div className="flex items-center justify-between p-4 border border-gray-300 rounded-xl shadow-sm">
                ...
                <div className="flex gap-2">
                    <button
                    type="button"
                    className="flex transition-all items-center justify-center gap-3 border-2 rounded-full px-4 py-2 font-semibold bg-blue-600 border-blue-600 text-white px-5 mx-2 hover:text-figma_blue hover:bg-white">

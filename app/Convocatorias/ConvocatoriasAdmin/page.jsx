            ...
            <div className="block max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow mx-auto">
              <header className="header-bg shadow-md text-center">
                <img
                  src="/images/owl.png"
                  alt="Owl Image"
                  className="owl-image mx-auto"
                />
                <div>
                  <h1 className="welcome-text">¡Bienvenido Señor Emplead@!</h1>
                  <h2 className="text-lg mt-4 text-figma-blue">
                    Utiliza las opciones disponibles para gestionar
                    convocatorias.
                  </h2>
                </div>
              </header>
            ...
            <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm md:mb-12 md:grid-cols-2 bg-white">
              <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e">
                <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 ">
                  ...
                  <p className="my-4">
                    Explora y revisa las convocatorias actuales y pasadas.
                  </p>
                </blockquote>
                <figcaption className="flex items-center justify-center">
                  <img
                    className="rounded-full w-9 h-9"
                    src="https://i.pinimg.com/564x/2c/2f/0b/2c2f0b549007c3addf71905265112680.jpg"
                    alt="profile picture"
                  />
              ...
              <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-se-lg">
                <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 ">
                  ...
                  <p className="my-4">
                    Añade nuevas instituciones educativas que ofrezcan programas
                    de intercambio.
                  </p>
                </blockquote>
                <figcaption className="flex items-center justify-center">
                  <img
                    className="rounded-full w-9 h-9"
                    src="https://i.pinimg.com/564x/25/1e/fd/251efd7f318b1b35fee3bcaf5efeb743.jpg"
                    alt="profile picture"
                  />
                </figcaption>
              </figure>
              <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-es-lg md:border-b-0 md:border-e">
                <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 ">
                  ...
                  <p className="my-4">
                    Revisa la documentación de los estudiantes inscritos en las
                    convocatorias.
                  </p>
                </blockquote>
                <figcaption className="flex items-center justify-center">
                  <img
                    className="rounded-full w-9 h-9"
                    src="https://i.pinimg.com/564x/bc/15/22/bc15223ab0c5cb10a717752d83688607.jpg"
                    alt="profile picture"
                  />
                  <div className="space-y-0.5 font-medium text-left rtl:text-right ms-3 text-black"></div>
                </figcaption>
              ...
              <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-se-lg">
                <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 ">
                  ...
                  <p className="my-4">
                    Selecciona a los estudiantes ganadores de cada convocatoria.
                  </p>
                </blockquote>
                <figcaption className="flex items-center justify-center">
                  <img
                    className="rounded-full w-9 h-9"
                    src="https://i.pinimg.com/564x/2d/c3/45/2dc345c6b68b986d0a080fb6c2bce569.jpg"
                    alt="profile picture"
                  />
                  <div className="space-y-0.5 font-medium text-left rtl:text-right ms-3 text-black"></div>
                </figcaption>
